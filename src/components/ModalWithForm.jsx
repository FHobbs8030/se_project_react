...
export default function ModalWithForm({ isOpen, title, onClose, onSubmit, submitText, children }) {
  if (!isOpen) return null;
  const handleOverlay = (e) => { if (e.target.classList.contains("modal")) onClose(); };
  return (
